...
export const psychologicalEvaluations = sqliteTable(
...
export const psychologicalMetrics = sqliteTable(
...
export type PsychologicalEvaluation =
  typeof psychologicalEvaluations.$inferSelect;
export type NewPsychologicalEvaluation =
  typeof psychologicalEvaluations.$inferInsert;
